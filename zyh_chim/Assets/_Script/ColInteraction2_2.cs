...
//三原子组成&碰撞代码其二
public class ColInteraction2_2 : MonoBehaviour
{
    ...
    void OnTriggerStay(Collider col)
    {
        ...
        {
            UpdateMove_2.bodyAlone = false;//发生碰撞
            {
                //发生碰撞时，氢原子往水分子处移动
                ...
                {
                    UpdateMove_2.move2 = true;//本原子 不在原点
    ...
    void OnTriggerExit(Collider col)
    {
        ...
        if (col.gameObject.name.CompareTo(colName) == 0)
        {
            UpdateMove_2.bodyAlone = true;//未碰撞
            if (UpdateMove.move == false || UpdateMove_2.move2 == false)//若1或2中任意一个 原子回到原点，表示氧原子可以还原
            {
